...
/******/ 	var hotCurrentHash = "af88dd9130ff48928287"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('app', '<qapp title="webVC" style="top:0;"></qapp> <qapp title="hy-normal" style="top:20%;"></qapp> <qapp title="hy-transparent" style="top:40%;"></qapp> <qapp title="hy-none" style="top:60%;"></qapp>', '', '', function (opts) {});
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('qapp', '<yo-header></yo-header>', '', '', function (opts) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('yo-header', '<h2 class="title">{parent.title}</h2>', 'yo-header,[riot-tag="yo-header"] { display: block; }', 'class="yo-header"', function (opts) {}, '{ }');
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html {\n  display: block;\n  position: relative;\n  width: 100%;\n  height: 100%;\n  overflow: hidden;\n  font-size: 100px; }\n  html body {\n    background-color: #fafafa;\n    width: 100%;\n    height: 100%;\n    margin: 20px; }\n    html body app {\n      display: block;\n      background-color: #fafafa;\n      position: absolute;\n      width: 100%;\n      height: 100%; }\n      html body app qapp {\n        display: block;\n        background-color: #fafafa;\n        position: absolute;\n        width: calc(100% - 40px);\n        height: 100%;\n        border-radius: 3px;\n        box-shadow: 0 0 2px #666; }\n", "", {"version":3,"sources":["/./src/src/style/global.scss"],"names":[],"mappings":"AAIA;EACI,eAAe;EACf,mBAAmB;EACnB,YAAY;EACZ,aAAa;EACb,iBAAiB;EACjB,iBAAiB,EAwBpB;EA9BD;IASQ,0BAXS;IAYT,YAAY;IACZ,aAAa;IACb,aAAa,EAiBhB;IA7BL;MAcY,eAAe;MACf,0BAjBK;MAkBL,mBAAmB;MACnB,YAAY;MACZ,aAAa,EAUhB;MA5BT;QAoBgB,eAAe;QACf,0BAvBC;QAwBD,mBAAmB;QACnB,yBAAW;QACX,aAAa;QACb,mBAAmB;QACnB,yBAAyB,EAC5B","file":"global.scss","sourcesContent":["@charset \"UTF-8\";\n\n$bgcolor: #fafafa;\n\nhtml{\n    display: block;\n    position: relative;\n    width: 100%;\n    height: 100%;\n    overflow: hidden;\n    font-size: 100px;\n\n    body{\n        background-color: $bgcolor;\n        width: 100%;\n        height: 100%;\n        margin: 20px;\n        app{\n            display: block;\n            background-color: $bgcolor;\n            position: absolute;\n            width: 100%;\n            height: 100%;\n            qapp{\n                display: block;\n                background-color: $bgcolor;\n                position: absolute;\n                width: calc(100% - 40px);\n                height: 100%;\n                border-radius: 3px;\n                box-shadow: 0 0 2px #666;\n            }\n        }\n    }\n}\n"],"sourceRoot":"webpack://"}]);
