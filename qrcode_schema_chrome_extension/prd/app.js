...
/******/ 	var hotCurrentHash = "90273fe206805c63e503"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('yo-list', '<h2 class="label"></h2> <item class="item"> <div class="mark"> 生成URL </div> <input name="url" type="text" class="flex" readonly style="border:0;"> </item> <h2 class="label"></h2> <item class="item"> <div class="mark flex"> 系统 </div> <div class="cont"> <label> <div class="yo-checked"> <input type="radio" name="os" value="qunaraphone" checked onchange="{toggle}"> <span class="type"></span> </div> android </label> <label> <div class="yo-checked"> <input type="radio" name="os" value="qunariphone" onchange="{toggle}"> <span class="type"></span> </div> iOS </label> </div> </item> <item class="item"> <div class="mark flex"> 压缩地址 </div> <div class="cont"> <label class="yo-switch" onclick="{compress}"> <input type="checkbox" onchange="{toggle}"> <div class="track"> <span class="handle"></span> </div> </label> </div> </item>', 'yo-list,[riot-tag="yo-list"]{ display: block; }', '', function (opts) {
